...
this._process();return true;};JSJaCConnection.prototype._doAuth=function(){this.has_sasl=false;if(this.has_sasl&&this.authtype=='nonsasl')
...
this.has_sasl = false;if(this.has_sasl)
